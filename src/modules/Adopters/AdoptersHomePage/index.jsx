...
import WebsiteBackgroud from "/public/images/Layouts/background.png";
...
export default function AdoptersHomePage() {
  return (
    <BackgroundLayout image={"images/Layouts/background.png"} dir={'col'} style={{gap:'7vh',padding:'40px 0'}} >
